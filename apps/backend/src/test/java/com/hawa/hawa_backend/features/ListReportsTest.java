...
class ListReportsTest {
    ...
    @Test
    void shouldReturnPaginatedReports_whenMultipleReportsExist() throws Exception {
    ...
    @Test
    void shouldFilterByBrandId_whenBrandIdParamProvided() throws Exception {
    ...
    @Test
    void shouldFilterByStatus_whenStatusParamProvided() throws Exception {
        createReport(brand, ReportStatusEnum.COMPLETED);
        createReport(brand, ReportStatusEnum.PENDING);
    ...
    @Test
    void shouldNotShowOtherCompanyReports_whenScopedByCompany() throws Exception {
    ...
    @Test
    void shouldIncludeReportsCreatedDuringDateToDay_whenDateToFilterUsed() throws Exception {
        createReport(brand, ReportStatusEnum.COMPLETED);
