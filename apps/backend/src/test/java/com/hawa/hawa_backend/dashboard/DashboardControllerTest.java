...
class DashboardControllerTest {
    ...
    class GetDashboard {
        ...
        @Test
        void shouldReturnDashboard_withBrandsAndStats() throws Exception {
        ...
        @Test
        void shouldReturnEmptyDashboard_whenNoBrands() throws Exception {
            mockMvc.perform(get("/api/dashboard")
                            .header("Authorization", "Bearer " + userToken))
                    .andExpect(status().isOk())
        ...
        @Test
        void shouldRespectRecentReportsLimit() throws Exception {
            Brand brand = createBrand("Nike", company);
            for (int i = 0; i < 10; i++) {
                createReport(brand, marketingUser, ReportStatusEnum.COMPLETED);
            }
        ...
        @Test
        void shouldNotShowOtherCompanyData() throws Exception {
